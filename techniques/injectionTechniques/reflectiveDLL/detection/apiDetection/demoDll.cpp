...
//BOOL virtualAllocCalled = FALSE;
//BOOL getProcAddressCalled = FALSE;
//BOOL createRemoteThreadCalled = FALSE;
//BOOL memcpyCalled = FALSE;
//BOOL readProcessMemoryCalled = FALSE;
//BOOL createProcessCalled = FALSE;
//BOOL virtualProtectCalled = FALSE;
...
//        //MessageBoxW(HWND_DESKTOP, L"Reflective injection detected (LoadLibrary). Killing Process.", L"Ghetto EDR", MB_OK);
...
//    if (virtualAllocCalled && getProcAddressCalled && loadLibraryCalled) {
//        //MessageBoxW(HWND_DESKTOP, L"Reflective injection detected(VirtualAlloc & getProcAddress & LoadLibrary). Killing Process.", L"Ghetto EDR", MB_OK);
//        //DWORD killPid = GetCurrentProcessId();
//        //HANDLE hKillProcess = OpenProcess(PROCESS_ALL_ACCESS, FALSE, killPid);
//        //TerminateProcess(hKillProcess, 0);
//    }
...
//    if (getProcAddressCalled && virtualAllocCalled && loadLibraryCalled) {
//        //MessageBoxW(HWND_DESKTOP, L"Reflective injection detected(GetProcAddress & VirtualAlloc & LoadLibrary). Killing Process.", L"Ghetto EDR", MB_OK);
//        //DWORD killPid = GetCurrentProcessId();
//        //HANDLE hKillProcess = OpenProcess(PROCESS_ALL_ACCESS, FALSE, killPid);
//        //TerminateProcess(hKillProcess, 0);
//    }
...
//    if (createProcessCalled) {
//        MessageBoxW(HWND_DESKTOP, L"Reflective injection detected(CreateProcessA). Killing Process.", L"Ghetto EDR", MB_OK);
//        //DWORD killPid = GetCurrentProcessId();
//        //HANDLE hKillProcess = OpenProcess(PROCESS_ALL_ACCESS, FALSE, killPid);
//        //TerminateProcess(hKillProcess, 0);
//    }
