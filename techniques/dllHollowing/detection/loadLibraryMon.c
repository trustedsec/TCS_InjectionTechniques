...
int monitorProcess(DWORD pid)
{
    ...
    char* dllPath = "C:\\Users\\%USERNAME%\\Desktop\\loadLibraryMon.dll";
    ...
    if (hThread != NULL)
    {
        ...
        printf("Successfully hooked into LoadLibrary for detection\n"); // New message
    }
    else
    {
...
int main()
{
    while (1) // Infinite loop
    {
        ...
        do
        {
            ...
            if (_stricmp(pe.szExeFile, "dll_hollowing.exe") == 0)
            {
